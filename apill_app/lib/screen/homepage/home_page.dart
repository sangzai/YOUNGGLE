...
import 'package:mainproject_apill/screen/homepage/appbar_controller.dart';
...
class HomePage extends StatelessWidget {
  ...
  final appBarCon = Get.put(AppBarCon());
      ...
      child: SafeArea(
        child: Column(
          children: [
            Obx(
              () => Visibility(
                visible: appBarCon.appbarcheck.value,
                child: AppBar(
                  ...
                  actions: [
                    IconButton(
                      ...
                      onPressed: () {
                        print(appBarCon.appbarcheck.value);
                        appBarCon.appbarcheck.value = !appBarCon.appbarcheck.value;
                      },
